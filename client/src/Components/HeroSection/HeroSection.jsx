...
const HeroSection = () => {
  ...
  return (
    ...
    <h3 className='mt-16 mx-10 sm:mx-20 text-center text-xl md:text-4xl pb-20 sm:pb-24 font-semibold'>
  ...
  <div className='flex justify-center items-center pb-16 text-xl'>
    ...
    className='border-[#fcc419] mr-8 border-2 px-3 py-2 rounded-full transition-all hover:bg-[#fcc419] hover:text-black font-bold'>Get Started</button>
    <button
