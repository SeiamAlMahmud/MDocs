        ...
        <>
            {
                isDeletePopupOpen && <div onClick={(event) => handleDeleteClosePopup(event)} className="createDocModelCon fixed h-screen w-screen inset-0  bg-[rgba(0,0,0,0.3)] flex flex-col justify-center items-center star">
                    ...
                    <div ref={popupDeleteRef} onClick={(e) => e.stopPropagation()} className='bg-[#fff]  w-[80vw] sm:w-[65vw] md:w-[55vw] lg:w-[45vw] xl:w-[37vw] rounded-lg p-4 flex flex-col'>
                        <h3 className='mt-2 mb-4 text-2xl font-bold'>Delete Document</h3>
                        <div className='flex items-center justify-normal gap-4'>
                            <i className='sm:text-7xl text-6xl text-[red]'><FaFileCircleXmark /> </i>
                        ...
                        <div className='flex items-center gap-2 justify-between w-full'>
                            <button onClick={deleteDoc} className='border-none outline-none w-1/2 text-center bg-[#1a1e2c] text-white capitalize py-1 sm:py-2 md:py-3 rounded-xl mt-6 hover:bg-[red]'>Delete</button>
                            <button onClick={closeCancelButtonHandler} className='border-none outline-none w-1/2 text-center bg-[#1a202c] text-white capitalize py-1 sm:py-2 md:py-3 rounded-xl mt-6 hover:bg-[#1d335d]'>Cancel</button>
                        </div>
                    </div>
                </div>
            }
